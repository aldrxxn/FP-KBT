      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-14 md:gap-4">
          ...
          <div className="space-y-4 max-w-[300px]">
            <h1 className="text-2xl font-bold">Braimy</h1>
            <p className="text-dark2">
            Platform inovatif yang dirancang khusus untuk mendukung institusi pendidikan dalam menciptakan pengalaman belajar modern. Fleksibel, adaptif, dan efisien.
            </p>
          </div>
          {/* second section */}
